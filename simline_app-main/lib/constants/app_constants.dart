...
String globalBaseVideoId = '';
String globalBuildVideoId = '';
String globalBoostVideoId = '';
String globalChallengeThumbnailImage = '';
...
const String isSocialLoggedIn = 'is_social_logged_in';
const String kKeyIsFirstTime = 'kKeyIsFirstTime';
const String kKeyFirstName = 'kKeyFirstName';
...
const String kChallengeImage = 'challengeImage';
const String kBaseVideoUrl = 'kBaseVideoUrl';
const String kBuildVideoUrl = 'kBuildVideoUrl';
const String kBoostVideourl = 'kBoostVideourl';
...
const String kkeyContry = 'kkeyContry';
// const String kKeyIsPremium = 'isPremium';
//order statuses
